...
import {setClassNum,setSearchRes,setSortRes} from "../Feature/Result/ResultSlice";
  ...
  return (
    ...
    <div className="filter-container">
        <div className="filter-first">
          ...
          />
          <FormSelect label="select Grade" list={classList} value={grade} onChange={handleGrade} />
          <FormSelect label="sort by" list={["high", "low"]} value={classSort} onChange={handleSort} />
        </div>
