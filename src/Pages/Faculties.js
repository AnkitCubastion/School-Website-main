  ...
  const searchFun = () => {
    ...
    let newArr = filteredState.filter((faculty)=>{
      ...
      if(teachName && subName){
        return (firstName?.toLowerCase() === teachName?.toLowerCase()||lastName?.toLowerCase() === teachName?.toLowerCase()) && faculty?.suject?.toLowerCase() === subName?.toLowerCase();
      }
      else if(teachName){
        return firstName?.toLowerCase() === teachName?.toLowerCase()||lastName?.toLowerCase() === teachName?.toLowerCase();
      }
      else if (subName){
