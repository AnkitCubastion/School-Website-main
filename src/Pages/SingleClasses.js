    ...
    <div className="container mt-4">
        ...
        <div className="row mt-4">
            ...
            <div key={teacher.id} className="col-md-4">
                <Link to={`/faculties/${teacher.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                <div className="card mb-4">
                    <img src={teacher.image} className="card-img-top" alt={teacher.name} style={{ objectFit: "fill", height: "300px" }} />
                    <div className="card-body">
        ...
        <div className="row mt-4">
            ...
            <div key={student.id} className="col-md-4">
                ...
                <div className="card mb-4">
                    <img src={student.image} className="card-img-top" alt={student.name} style={{ objectFit: "fill", height: "350px" }} />
                    <div className="card-body">
